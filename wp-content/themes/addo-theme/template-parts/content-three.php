...
<div class="section" id="section-three" data-anchor="OurBrands">
    ...
    <div class="image-sign">
        <a href="http://www.thetoyshop.com/brands/addo">
            <img data-src="<?php bloginfo('template_directory');?>/assets/img/Go-To-Shop.svg" class="img-responsive" />
        </a>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div id="randomize">
                        <div class="row">
                            <div id="slot-col-1" class="col-xs-4">
                                <div>
                                    <div id="test-slot">
                            ...
                            <div id="slot-col-2" class="col-xs-4">
                                <div>
                            ...
                            <div id="slot-col-3" class="col-xs-4">
                                <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4">
                                    <div class="btn-group btn-group-justified btn-group-randomize btn-slot-large" role="group">
                                        <div id="ranomizeButton" type="button" class="btn btn-danger btn-lg ranomizeButton">PRESS ME!</div>
                                    </div>
                                </div>
                                <div class="col-xs-4">
